...
const kLocalRoot = "http://localhost:8080/wedding_organizer/";
...
{
    path: '/edit_task/',
    url: './pages/edit_task.html?r=88245',
    name: 'edit_task',
},
{
    path: '/new_task/',
    url: './pages/new_task.html?r=60041',
    name: 'new_task',
},
{
    path: '/task_detail_page/',
    url: './pages/task_detail_page.html?r=23732',
    name: 'task_detail_page',
},
{
    path: '/test/',
    url: './pages/test.html?r=72370',
    name: 'test',
},
{
    path: '(.*)',
