...
const kLocalRoot = "http://localhost/wedding_organizer/";
...
var routes = [
  ...
  {
    path: "/edit_task/",
    url: "./pages/edit_task.html?r=63108",
    name: "edit_task",
  },
  {
    path: "/vendors/",
    url: "./pages/vendors.html",
    name: "vendors",
  },
  {
    path: "/new_task/",
    url: "./pages/new_task.html?r=38958",
    name: "new_task",
  },
  {
    path: "/task_detail_page/",
    url: "./pages/task_detail_page.html?r=91649",
    name: "task_detail_page",
  },
  {
    path: "/test/",
    url: "./pages/test.html?r=43180",
    name: "test",
  },
  {
    path: "/new_vendor/",
    url: "./pages/new_vendor.html?r=87765",
    name: "new_vendor",
  },
  {
    path: "/vendor_detail/",
    url: "./pages/vendor_detail.html?r=43349",
    name: "vendor_detail",
  },
  {
    path: "(.*)",
...
var app = new Framework7({
  version: "1.0.0",
  id: "com.thorium.wedding_organizer",
  root: "#app",
  theme: theme,
  autoDarkTheme: false,
  language: "en",
